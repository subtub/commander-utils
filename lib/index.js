...
CommanderUtils.prototype.commandUpdate = function(config) {
  ...
  this.commander
    ...
    .action(function(options) {
      requestPackageJson(config.packageJsonUrl, function(data) {
        var latestVersion = data.version;
        if (options.check) {
          checkVersion(currentVersion, latestVersion);
        } else {
          if (checkVersion(currentVersion, latestVersion)) {
 ...
 */
function requestPackageJson(url, callback) {
 ...
 */
function checkVersion(currentVersion, latestVersion) {
